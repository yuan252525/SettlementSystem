...
const processKeyAndData=(data,resultData,flag,filterStr)=>{
	let kyes,reg= flag ? /([A-Z])/g : /_(.)/g,toCase = flag ? ''.toLocaleLowerCase : ''.toLocaleUpperCase;
 ...
 */
export { offset,query, queryAll, uuid, uuidV4, sortObject, base64decode, base64encode, sha256, sha1, md5, clone, getQueryString, deepCopy, bubbleSort, mycurrency1, processKeyAndData };
