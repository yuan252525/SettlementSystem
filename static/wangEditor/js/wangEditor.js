...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        editor.ready(function () {
            ...
            if (uploadImgUrl || customUpload || uploadImgShowBase64) {
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        if (!uploadImgUrl&&!config.uploadImgShowBase64) {
            return;
        }
        ...
        editor.xhrUploadImg = function (opt) {
            ...
            // ------------ begin 预览模拟上传 ------------
            if (editor.config.uploadImgShowBase64){//E.isOnWebsite) {
                E.log('预览模拟上传');
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        if (!customUpload) {
            return;
        } else if (editor.config.uploadImgUrl&&!config.uploadImgShowBase64) {
